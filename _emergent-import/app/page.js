  ...
  return (
    <div className="min-h-screen ">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative pt-20 sm:pt-16 pb-16 sm:pb-20 text-center px-4">
          <h1 className="font-display font-bold tracking-tight mb-4 sm:mb-6 max-w-5xl mx-auto text-[#F5F1FA] leading-[1.2] text-[24px] sm:text-3xl md:text-5xl lg:text-6xl">
            {t('land.title1')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A78BCF] via-[#8B5CF6] to-[#F2E9D8]">{t('land.title2')}</span>
          </h1>
      ...
      <section className="section-light">
        <div className="container pt-14 pb-2">
          <div className="flex items-end justify-between mb-6 gap-3 flex-wrap">
            <div>
              <p className="font-label text-xs text-[#8A7CA0] mb-2">{t('land.trending')}</p>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-[#1A152F]">{t('land.availableagents')}</h2>
            </div>
      ...
      <section className="section-light">
        ...
        <div className="text-center mb-12">
          <p className="font-label text-xs text-[#8A7CA0] mb-3">{t('land.reviews')}</p>
          <h2 className="font-display text-4xl md:text-5xl font-bold text-[#1A152F]">{t('land.usersay')}</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
