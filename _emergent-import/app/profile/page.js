      ...
      <div className="container py-10">
        ...
        <div className="bg-[#110D24] border border-[#251A40] rounded-2xl p-6 md:p-8 mb-8">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-5">
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-gradient-to-br from-[#6B3FA0] to-[#8B5CF6] flex items-center justify-center text-white text-3xl font-stat shrink-0">{currentUser.avatar}</div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap mb-1">
                <h1 className="font-display text-3xl md:text-4xl font-bold text-[#F5F1FA]">{currentUser.name}</h1>
              ...
              <p className="text-sm text-[#A78BCF] mb-3">{currentUser.job} · {memberSince}</p>
