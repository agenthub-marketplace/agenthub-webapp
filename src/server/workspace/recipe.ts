  ...
  if (locale === "en") {
    return {
      ...
      outcomeChecklist: {
        ...
        missingHistory: "Use the workspace once before leaving a verified review.",
  ...
  return {
    ...
    startupPlan: {
      ...
      lastRunHints: {
        ...
        succeeded: "Ouvrez le résultat stocké avant de relancer une exécution.",
      },
      historyPreview: {
      ...
      outcomeChecklist: {
        ...
        missingHistory: "Utilisez le workspace au moins une fois avant de laisser un avis vérifié.",
