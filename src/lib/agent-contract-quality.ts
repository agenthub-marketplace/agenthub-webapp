...
export function evaluateAgentContractQuality(input: AgentContractQualityInput): AgentContractQualityReport {
  ...
  addCheck(checks, {
    ...
    detail: "Le nom doit etre clair pour la marketplace et le workspace.",
    severity: "blocker",
  ...
  addCheck(checks, {
    id: "summary_present",
    label: "Resume clair",
    detail: "Le resume doit expliquer rapidement ce que l'utilisateur obtient.",
    severity: "blocker",
  ...
  addCheck(checks, {
    ...
    detail: "Les agents forbidden_beta restent hors beta fermee.",
    severity: "blocker",
  ...
  addCheck(checks, {
    ...
    label: "Capacites remplies",
    detail: "Les capacites aident l'utilisateur et le prompt runner a cadrer l'agent.",
    severity: "warning",
  ...
  addCheck(checks, {
    ...
    label: "Inputs prepares",
    detail: "Les inputs attendus doivent etre comprehensibles avant l'usage.",
    severity: "warning",
  ...
  addCheck(checks, {
    ...
    detail: "L'utilisateur doit comprendre le resultat attendu.",
    severity: "blocker",
  ...
  addCheck(checks, {
    ...
    detail: "Les limites doivent etre visibles avant validation admin.",
    severity: "blocker",
  ...
  addCheck(checks, {
    ...
    detail: "La promesse de resultat doit resumer ce que le workspace produit.",
    severity: "blocker",
  ...
  addCheck(checks, {
    ...
    label: "Exemples de resultat",
    detail: "Au moins un exemple aide l'admin a valider la promesse.",
    severity: "warning",
  ...
  addCheck(checks, {
    ...
    label: "Setup document coherent",
    detail: "Un workspace document doit expliquer ce que l'utilisateur prepare.",
    severity: "warning",
  ...
  addCheck(checks, {
    ...
    label: "Execution compatible beta fermee",
    detail: "Les 5 agents beta doivent etre LLM texte sans fichier ni outil externe.",
    severity: "warning",
