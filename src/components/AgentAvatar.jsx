...
export default function AgentAvatar({ index = 0, size = 'md', shape = 'rounded', className = '' }) {
  const sizes = {
    xs: 'w-8 h-8 text-xs',
  ...
  return (
    <div className={`relative ${shapeClass} bg-gradient-to-br ${g} ${sizes[size]} ${className} overflow-hidden`}>
